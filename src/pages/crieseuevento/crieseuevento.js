            ...
            <div>
                ...
                <main className="main-crieseuevento">
                    <div className="formulario div-um">
                        <div className="logo_test">
                        <img src={require('../../assets/img/logoarte.png')} className="crie" alt="imagem de uma placa de madeira que é o simbolo da pagina" />
                        </div>
             ...
             <p className="titulo-nome5">Escolha uma imagem para o seu evento: </p>
              ...
              <button type="button" class="btn btn-link">Link</button>
                    ...
                    <div className="div-tres">
                        <img src={require("../../assets/img/trocpica.png")} className="banner-1" alt="" />
                    </div>
               </main>
               </div>
        )
